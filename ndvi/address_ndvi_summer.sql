...
declare
	...
	ndvi text := 'sh_ndvi_scale_summer_crs4499';
...
begin
	...
	loop
		...
		sql := '
		drop table if exists address_ndvi_summer_s' || i || ';
		create table address_ndvi_summer_s' || i || ' as select b.id, sum((intsct.dn*intsct.area)/st_area(b.b'|| i ||')) as ndvi_summer_s' || i || '
