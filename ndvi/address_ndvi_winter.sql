...
declare
	...
	ndvi text := 'sh_ndvi_scale_winter_crs4499_fixed';
...
begin
	...
	loop
		...
		sql := '
		drop table if exists address_ndvi_winter_s' || i || ';
		create table address_ndvi_winter_s' || i || ' as select b.id, sum((intsct.dn*intsct.area)/st_area(b.b'|| i ||')) as ndvi_winter_s' || i || '
