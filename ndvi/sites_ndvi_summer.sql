...
begin
	...
	loop
		...
		sql := '
		drop table if exists sites_ndvi_summer_s' || i || ';
		create table sites_ndvi_summer_s' || i || ' as select b.id, sum((intsct.dn*intsct.area)/st_area(b.b'|| i ||')) as ndvi_summer_s' || i || '
