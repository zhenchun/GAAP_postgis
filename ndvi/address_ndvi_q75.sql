...
declare
	...
	ndvi text := 'sh_ndvi_scale_q75_crs4499';
...
begin
	...
	loop
		...
		sql := '
		drop table if exists address_ndvi_q75_' || i || ';
		create table address_ndvi_q75_' || i || ' as select b.id, sum((intsct.dn*intsct.area)/st_area(b.b'|| i ||')) as ndvi_q75_s' || i || '
