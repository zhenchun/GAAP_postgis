...
declare
	...
	ndvi text := 'sh_ndvi_scale_q25_crs4499_fixed';
...
begin
	...
	loop
		...
		sql := '
		drop table if exists address_ndvi_q25_' || i || ';
		create table address_ndvi_q25_' || i || ' as select b.id, sum((intsct.dn*intsct.area)/st_area(b.b'|| i ||')) as ndvi_q25_s' || i || '
