...
declare 
	...
	roads text := 'shkd_crs4499'; --constant_nor_lur_bng_dists, all_vehsum, allmv
	sql text;
begin
	--find nearest neighbours
	sql := '
	drop table if exists address_m_to_shkd;
	create table address_m_to_shkd as 
	with nn as (
	...
	from
		(select nn.id, st_distance(nn.geom, t.geom) as m_to_shkd
